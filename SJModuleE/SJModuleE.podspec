...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/lsw891227/SJModuleE"
  ...
  s.source       = { :git => "https://github.com/lsw891227/SJModuleE.git", :tag => s.version.to_s }
  ...
  s.source_files  = "SJModuleE/SJModuleE/**/*.{h,m,swift}"
